...
ma <<- metabin(event.e = exposed_N_cases,
                            ...
                            allstudies = TRUE, # to force OR calculation for Falcioni 0.1 W/kg 
...
output_file = "/males_glioma_highestdose_fixed-MH-TACC.txt"
sink(paste0(saveto, output_file))
ma
sink()

# we save the forest plots
png(paste0(saveto, "/males_glioma_highestdose.png"), 11,6, units = "in", res = 300)
forest(ma)
...
pdf(paste0(saveto, "/males_glioma_highestdose.pdf"), 11,6)
forest(ma)
grid.text( "Meta-analysis of gliomas in male rats", x = 0.5, y = 0.9, gp = gpar(cex = 1.5))
grid.text( "(NTP numbers are poly3-adjusted, treatment arm continuity correction)", x = 0.5, y = 0.1, gp = gpar(cex = 1))
dev.off()
...
###### Funnel Plot ######
png(paste0(saveto, "/males_glioma_highestdose_FUNNEL.png"), 10,6, units = "in", res = 300)
...
pdf(paste0(saveto, "/males_glioma_highestdose_FUNNEL.pdf"), 10,6)
meta::funnel(ma, cex=1.2, common=TRUE, log = "x", yaxis = "se", studlab=TRUE, xlab="Odds Ratio (log axis)")
title(main="Funnel plot: highest exposure contrast, male rats")
dev.off()
...
output_file = "/males_glioma_highestdose_fixed-MH-TACC_noDblZero.txt"
sink(paste0(saveto, output_file))
ma_sens
sink()

# we save the forest plots
png(paste0(saveto, "/males_glioma_highestdose_noDblZero.png"), 11,6, units = "in", res = 300)
forest(ma_sens)
grid.text( "Meta-analysis of gliomas in male rats", x = 0.5, y = 0.9, gp = gpar(cex = 1.5))
grid.text( "(NTP numbers are poly3-adjusted, treatment arm continuity correction)", x = 0.5, y = 0.1, gp = gpar(cex = 1))
dev.off()

pdf(paste0(saveto, "/males_glioma_highestdose_noDblZero.pdf"), 11,6)
forest(ma_sens)
grid.text( "Meta-analysis of gliomas in male rats", x = 0.5, y = 0.9, gp = gpar(cex = 1.5))
grid.text( "(NTP numbers are poly3-adjusted, treatment arm continuity correction)", x = 0.5, y = 0.1, gp = gpar(cex = 1))
dev.off()
...
output_file = "/males_glioma_doseaggr_fixed-MH-TACC.txt"
sink(paste0(saveto, output_file))
ma_aggr
sink()

# we save the forest plots
png(paste0(saveto, "/males_glioma_dosesaggr.png"), 11,6.5, units = "in", res = 300)
forest(ma_aggr)
...
pdf(paste0(saveto, "/males_glioma_dosesaggr.pdf"), 11,6.5)
forest(ma_aggr)
grid.text( "Meta-analysis of gliomas in male rats,\nnumbers from different exposure levels combined", x = 0.5, y = 0.9, gp = gpar(cex = 1.5))
grid.text( "(NTP numbers are poly3-adjusted, treatment arm continuity correction)", x = 0.5, y = 0.1, gp = gpar(cex = 1))
dev.off()
...
###### Funnel Plot ######
png(paste0(saveto, "/males_glioma_dosesaggr_FUNNEL.png"), 10,6, units = "in", res = 300)
...
pdf(paste0(saveto, "/males_glioma_dosesaggr_FUNNEL.pdf"), 10,6)
meta::funnel(ma_aggr, cex=1.2, common=TRUE, log = "x", yaxis = "se", studlab=TRUE, xlab="Odds Ratio (log axis)")
title(main="Funnel plot: aggregated exposure levels, male rats")
dev.off()
...
ma_aggr_sens <<- metabin(event.e = exposed_N_cases,
                    ...
                    method = "MH",
                    incr = "TACC",  # otherwise we'd get an OR of 2.0 for the Falcioni 0.1 W/kg group
                    allstudies = FALSE,  # to force OR calculation for double-zero studies
...
# we save the model output to text
output_file = "/males_glioma_doseaggr_fixed-MH-TACC_noDblZero.txt"
sink(paste0(saveto, output_file))
ma_aggr_sens
sink()

# we save the forest plots
png(paste0(saveto, "/males_glioma_dosesaggr_noDblZero.png"), 11,6.5, units = "in", res = 300)
forest(ma_aggr_sens)
grid.text( "Meta-analysis of gliomas in male rats,\nnumbers from different exposure levels combined", x = 0.5, y = 0.9, gp = gpar(cex = 1.5))
grid.text( "(NTP numbers are poly3-adjusted, treatment arm continuity correction)", x = 0.5, y = 0.1, gp = gpar(cex = 1))
dev.off()

pdf(paste0(saveto, "/males_glioma_dosesaggr_noDblZero.pdf"), 11,6.5)
forest(ma_aggr_sens)
grid.text( "Meta-analysis of gliomas in male rats,\nnumbers from different exposure levels combined", x = 0.5, y = 0.9, gp = gpar(cex = 1.5))
grid.text( "(NTP numbers are poly3-adjusted, treatment arm continuity correction)", x = 0.5, y = 0.1, gp = gpar(cex = 1))
dev.off()
