...
png(paste0(saveto, "/female_glioma_alldoses_frTACC.png"), 11,6, units = "in", res = 300)
forest(ma)
...
pdf(paste0(saveto, "/female_glioma_alldoses_frTACC.pdf"), 11,6)
forest(ma)
grid.text( "Meta-analysis of gliomas in female rats", x = 0.5, y = 0.9, gp = gpar(cex = 1.5))
grid.text( "(NTP numbers are poly3-adjusted, fractional per study treatment arm continuity correction)", x = 0.5, y = 0.1, gp = gpar(cex = 1))
dev.off()
...
ORs = as.numeric(forest$effect.format[4:12])
ORs
...
output_file <- "/female_glioma_frTACC_lin_freemov_ModelSummary.txt"
...
#pdf plot
pdf(paste0(saveto, "/female_glioma_frTACC_lin_freemov.pdf"), 7,4)
with(predict(lin_bin, dosex_bin, order=TRUE, exp=TRUE), {plot(dose, pred, type="l", log="y", col="blue", ylim=c(0.5, (max(exp(data_bin$logrr))+0.1*(max(exp(data_bin$logrr))))), ylab="glioma odds ratio", xlab="SAR, W/kg", axes=FALSE)
...
#png lot
png(paste0(saveto, "/female_glioma_frTACC_lin_freemov.png"), 7,4, unit = "in", res= 300)
with(predict(lin_bin, dosex_bin, order=TRUE, exp=TRUE), {plot(dose, pred, type="l", log="y", col="blue", ylim=c(0.5, (max(exp(data_bin$logrr))+0.1*(max(exp(data_bin$logrr))))), ylab="glioma odds ratio", xlab="SAR, W/kg", axes=FALSE)
...
output_file <- "/female_glioma_frTACC_lin_Restr_ModelSummary.txt"
...
#pdf plot
pdf(paste0(saveto, "/female_glioma_frTACC_lin_Restr.pdf"), 7,4)
with(predict(lin_bin, dosex_bin, order=TRUE, exp=TRUE), {plot(dose, pred, type="l", log="y", col="blue", ylim=c(0.3, (max(exp(data_bin[9:13,]$logrr))+0.1*(max(exp(data_bin[9:13,]$logrr))))), ylab="glioma odds ratio", xlab="SAR, W/kg", axes=FALSE)
...
#plot png
png(paste0(saveto, "/female_glioma_frTACC_lin_Restr.png"), 7,4, unit = "in", res= 300)
with(predict(lin_bin, dosex_bin, order=TRUE, exp=TRUE), {plot(dose, pred, type="l", log="y", col="blue", ylim=c(0.3, (max(exp(data_bin[9:13,]$logrr))+0.1*(max(exp(data_bin[9:13,]$logrr))))), ylab="glioma odds ratio", xlab="SAR, W/kg", axes=FALSE)
...
output_file <- "/female_glioma_frTACC_quad_freemov_ModelSummary.txt"
...
#pdf plot
pdf(paste0(saveto, "/female_glioma_frTACC_quad_freemov.pdf"), 7,4)
with(predict(quad_bin, dosex_bin, order=TRUE, exp=TRUE), {plot(dose, pred, type="l", log="y",col="blue", ylim=c(0.3, (max(exp(data_bin$logrr))+0.1*(max(exp(data_bin$logrr))))), ylab="glioma odds ratio", xlab="SAR, W/kg", axes=FALSE)
...
#png plot
png(paste0(saveto, "/female_glioma_frTACC_quad_freemov.png"), 7,4, unit = "in", res= 300)
...
output_file <- "/female_glioma_frTACC_quad_Restr_ModelSummary.txt"
...
#üdf plot
pdf(paste0(saveto, "/female_glioma_frTACC_quad_Restr.pdf"), 7,4)
with(predict(quad_bin, dosex_bin, order=TRUE, exp=TRUE), {plot(dose, pred, type="l", log="y", col="blue", ylim=c(0.1, (max(exp(data_bin[9:13,]$logrr))+0.1*(max(exp(data_bin[9:13,]$logrr))))), ylab="glioma odds ratio", xlab="SAR, W/kg", axes=FALSE)
...
#png plot
png(paste0(saveto, "/female_glioma_frTACC_quad_Restr.png"), 7,4, unit = "in", res= 300)
