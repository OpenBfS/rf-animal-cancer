...
png(paste0(saveto, "/males_glioma_alldoses_frTACC_RR.png"), 11,6, units = "in", res = 300)
forest(ma)
...
pdf(paste0(saveto, "/males_glioma_alldoses_frTACC_RR.pdf"), 11,6)
forest(ma)
grid.text( "Meta-analysis of gliomas in male rats", x = 0.5, y = 0.9, gp = gpar(cex = 1.5))
grid.text( "(NTP numbers are poly3-adjusted, fractional per study treatment arm continuity correction)", x = 0.5, y = 0.1, gp = gpar(cex = 1))
dev.off()
...
output_file <- "/males_glioma_frTACC_lin_freemov_ModelSummary_RR.txt"
...
#plot pdf
pdf(paste0(saveto, "/males_glioma_frTACC_lin_freemov_RR.pdf"), 7,4)

with(predict(lin_bin, dosex_bin, order=TRUE, exp=TRUE), {plot(dose, pred, type="l", col="blue", log="y", ylim=c(0.3, (max(exp(data_bin$logrr))+0.1*(max(exp(data_bin$logrr))))), ylab="glioma risk ratio", xlab="SAR, W/kg", axes=FALSE)
...
#plot png
png(paste0(saveto, "/males_glioma_frTACC_lin_freemov_RR.png"), 7,4, unit = "in", res= 300)
...
output_file <- "/males_glioma_frTACC_lin_freemov_noDblZero_ModelSummary_RR.txt"
...
#plot pdf
pdf(paste0(saveto, "/males_glioma_frTACC_lin_freemov_noDblZero_RR.pdf"), 7,4)
...
#plot png
png(paste0(saveto, "/males_glioma_frTACC_lin_freemov_noDblZero_RR.png"), 7,4, unit = "in", res= 300)
...
output_file <- "/males_glioma_frTACC_lin_Restr_ModelSummary_RR.txt"
...
#plot pdf
pdf(paste0(saveto, "/males_glioma_frTACC_lin_Restr_RR.pdf"), 7,4)


with(predict(lin_bin, dosex_bin, order=TRUE, exp=TRUE), {plot(dose, pred, type="l", col="blue", log="y", ylim=c(0.3, (max(exp(data_bin[9:13,]$logrr))+0.1*(max(exp(data_bin[9:13,]$logrr))))), ylab="glioma risk ratio", xlab="SAR, W/kg", axes=FALSE)
...
#plot png
png(paste0(saveto, "/males_glioma_frTACC_lin_Restr_RR.png"), 7,4, unit = "in", res= 300)
...
output_file <- "/males_glioma_frTACC_quad_freemov_ModelSummary_RR.txt"
...
#plot pdf
pdf(paste0(saveto, "/males_glioma_frTACC_quad_freemov_RR.pdf"), 7,4)

with(predict(quad_bin, dosex_bin, order=TRUE, exp=TRUE), {plot(dose, pred, type="l", col="blue", log="y", ylim=c(0.1, (max(exp(data_bin$logrr))+0.1*(max(exp(data_bin$logrr))))), ylab="glioma risk ratio", xlab="SAR, W/kg", axes=FALSE)
...
#plot png
png(paste0(saveto, "/males_glioma_frTACC_quad_freemov_RR.png"), 7,4, unit = "in", res= 300)
...
output_file <- "/males_glioma_frTACC_quad_Restr_ModelSummary_RR.txt"
...
#plot pdf
pdf(paste0(saveto, "/males_glioma_frTACC_quad_Restr_RR.pdf"), 7,4)

with(predict(quad_bin, dosex_bin, order=TRUE, exp=TRUE), {plot(dose, pred, type="l", col="blue", log="y", ylim=c(0.05, (max(exp(data_bin[9:13,]$logrr))+0.1*(max(exp(data_bin[9:13,]$logrr))))), ylab="glioma risk ratio", xlab="SAR, W/kg", axes=FALSE)
...
#plot png
png(paste0(saveto, "/males_glioma_frTACC_quad_Restr_RR.png"), 7,4, unit = "in", res= 300)
